...
const OrderPendingYarnStock = () => {
    ...
    const fetchData = async () => {
        try {
            const url = `${process.env.REACT_APP_HOST}/api/stock/getOrderStock?limit=${pagination?.pageSize}&offset=${pagination?.currentPage - 1}`
...
export default OrderPendingYarnStock